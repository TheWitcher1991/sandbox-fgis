...
from enterprises.controllers.manufacturer import ManufacturerSetController
...
router = auto_router(AuthoritySetController, ShipperSetController, ConsigneeSetController, ManufacturerSetController)
